...
<div class="single-image wow fadeIn" data-wow-delay=".5s">
  <img src="{{ asset('assets/images/hero/hero-image.png') }}" alt="web development" class="img-fluid" />
</div>
</div>
</div>
</div>
...
<img src="{{ asset('assets/images/about/about-image.png') }}" alt="about" class="img-fluid no-shadow" />
</div>
</div>
<div class="col-lg-6">
...
<div class="user- mt30">
  <div class="media">
    <div class="user-image bdr-radius"><img src="{{ asset('assets/images/user-thumb/girl2.jpg') }}" alt="girl" class="img-fluid" /></div>
...
<div class="s-card-icon"><img src="{{ asset('assets/images/icons/marketing.svg') }}" alt="service" class="img-fluid"/></div>
...
<div class="statistics">
<div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
  <img src="{{ asset('assets/images/icons/deal.svg') }}" alt="happy" class="img-fluid" />
</div>
<div class="statnumb">
...
<div class="statistics">
<div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
  <img src="{{ asset('assets/images/icons/computers.svg') }}" alt="project" class="img-fluid" />
</div>  
...
<div class="statistics">
<div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
  <img src="{{ asset('assets/images/icons/worker.svg') }}" alt="work" class="img-fluid" />
</div>
<div class="statnumb">
...
<div data-tilt data-tilt-max="20" data-tilt-speed="1000" class="statistics-img">
  <img src="{{ asset('assets/images/icons/customer-service.svg') }}" alt="support" class="img-fluid" />
</div>
<div class="statnumb">
  <span>24/7</span>
...
<div class="isotope_item hover-scale">
<div class="item-image" data-tilt data-tilt-max="2" data-tilt-speed="1000">
  <a href="#"><img src="{{ asset('assets/images/portfolio/image-1.jpg') }}" alt="image" class="img-fluid" /> </a>
</div>
<div class="item-info">
...
<div class="isotope_item hover-scale">
<div class="item-image" data-tilt data-tilt-max="2" data-tilt-speed="1000">
  <a href="#"><img src="{{ asset('assets/images/portfolio/image-6.jpg') }}" alt="image" class="img-fluid" /> </a>
</div>
<div class="item-info">
...
<div class="isotope_item hover-scale">
<div class="item-image" data-tilt data-tilt-max="2" data-tilt-speed="1000">
  <a href="#"><img src="{{ asset('assets/images/portfolio/image-c.jpg') }}" alt="image" class="img-fluid" /> </a>
</div>
<div class="item-info">
...
<ul>
  <li class=" wow fadeIn" data-wow-delay=".2s">
    <div class="clients-logo"><img src="{{ asset('assets/images/client/clients-1.png') }}" alt="text" class="img-fluid"/></div>
  </li>
  <li class=" wow fadeIn" data-wow-delay=".4s">
    <div class="clients-logo"><img src="{{ asset('assets/images/client/clients-2.png') }}" alt="text" class="img-fluid"/></div>
  </li>
  <li class=" wow fadeIn" data-wow-delay=".6s">
    <div class="clients-logo"><img src="{{ asset('assets/images/client/clients-3.png') }}" alt="text" class="img-fluid"/></div>
  </li>
  <li class=" wow fadeIn" data-wow-delay=".8s">
    <div class="clients-logo"><img src="{{ asset('assets/images/client/clients-4.png') }}" alt="text" class="img-fluid"/></div>
  </li>
  <li class=" wow fadeIn" data-wow-delay="1s">
    <div class="clients-logo"><img src="{{ asset('assets/images/client/clients-5.png') }}" alt="text" class="img-fluid"/></div>
  </li>
</ul>
</div>
</div>
...
<div class="testimonial-card">
  ...
  <div class="client-thumbs mt30">
    <div class="media v-center">
      <div class="user-image bdr-radius"><img src="{{ asset('assets/images/user-thumb/girl.jpg') }}" alt="girl" class="img-fluid" /></div>
      <div class="media-body user-info v-center">
        <h5>Moana Smile</h5>
...
<img src="{{ asset('assets/images/about/hellopic.png') }}" alt="enquire" class="img-fluid" />
</div>
</div>
</div>
</div>
...
<div class="skyline-img" data-tilt data-tilt-max="4" data-tilt-speed="1000">
  <img src="{{ asset('assets/images/location/newyork.png') }}" alt="New York" class="img-fluid" />
</div>
...
<div class="office-card">
<div class="skyline-img" data-tilt data-tilt-max="4" data-tilt-speed="1000">
  <img src="{{ asset('assets/images/location/sydeny.png') }}" alt="sydney" class="img-fluid" />
</div>
<div class="office-text">
  <h4>Sydney</h4>
...
<div class="skyline-img" data-tilt data-tilt-max="4" data-tilt-speed="1000">
  <img src="{{ asset('assets/images/location/rome.png') }}" alt="rome" class="img-fluid" />
</div>
<div class="office-text">
  <h4>Rome</h4>
