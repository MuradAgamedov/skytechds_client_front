...
<div class="col-lg-3 col-sm-6  ftr-brand-pp">
 <a class="navbar-brand mt30 mb25 f-dark-logo" href="#"> <img src="{{ asset('assets/images/logo.png') }}" alt="Logo"/></a>
 <a class="navbar-brand mt30 mb25 f-white-logo" href="#"> <img src="{{ asset('assets/images/white-logo.png') }}" alt="Logo" /></a>
 <p>News letter dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt. Enter your email</p>
...
<div class="col-lg-12">
  ...
  <div class="footer-">
    <p>© 2020-2025 All Rights Reserved By <a href="https://themeforest.net/user/separateweb/portfolio" target="blank">Separateweb</a></p>
  </div>
</div>
</div>
</div>
